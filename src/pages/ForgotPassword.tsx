...
export default function ForgotPassword() {
      ...
      <div className="min-h-[calc(100vh-80px)] bg-[#fafbfc] flex items-center justify-center p-4">
        ...
        >
          <div className="bg-white rounded-[2.5rem] shadow-md p-10 lg:p-14 border border-slate-100 flex flex-col items-center relative overflow-hidden">
            ...
            <h2 className="text-3xl font-black text-slate-900 tracking-tight mb-4 uppercase relative z-10">Email Sent!</h2>
            <p className="text-slate-400 font-semibold mb-8 text-xs text-center relative z-10 leading-relaxed">
              We've sent a password reset link to <span className="text-indigo-600 font-black">{email}</span>. Check your inbox and follow the instructions.
            </p>
  ...
  return (
    <div className="min-h-[calc(100vh-80px)] bg-[#fafbfc] flex items-center justify-center p-4">
      ...
      >
        <div className="bg-white rounded-[2.5rem] shadow-md p-10 lg:p-14 border border-slate-100 flex flex-col items-center relative overflow-hidden">
          <div className="w-18 h-18 bg-indigo-50 text-indigo-600 border border-indigo-100 rounded-3xl flex items-center justify-center mb-8 shadow-sm relative z-10 hover:rotate-6 transition-transform">
            <Mail size={32} />
          </div>
          <h2 className="text-3xl font-black text-slate-900 tracking-tight mb-2 uppercase relative z-10">Reset Password</h2>
          <p className="text-slate-400 font-semibold mb-8 text-xs relative z-10 text-center">Enter your email to receive reset instructions</p>
          ...
          <div className="mt-6 w-full text-center relative z-10">
            <Link to="/login" className="text-slate-400 text-xs font-extrabold uppercase tracking-wider hover:text-indigo-600 transition-colors flex items-center justify-center gap-2">
              <ArrowLeft size={14} />
              Back to Login
            </Link>
          </div>
